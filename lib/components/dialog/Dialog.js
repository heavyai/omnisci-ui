 ...
 * Dialog
 */
exports.SimpleDialog = ({ primaryLabel = "Ok", secondaryLabel = "Cancel", primaryAction, secondaryAction, message, onClose = () => { }, onOpen = () => { }, title, open, type, hideCloseIcon, onCloseFromHeader, children, footer, className, onStateChange, preventOutsideDismiss, actionToApplyOnEnter }) => {
    const handlePrimary = () => {
        if (primaryAction) {
            primaryAction();
        }
    ...
    return (react_1.default.createElement(dialog_1.Dialog, { className: classnames_1.default(type, className), open: open, onOpen: onOpen, onStateChange: e => {
        ...
        react_1.default.createElement(dialog_1.DialogContent, null, children ?
